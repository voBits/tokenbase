from urllib.parse import urlparse
	...
	def twitter_style(token_info):
	    """
	    Blah Token $BLAH by [@blah_com|blah.com] is now available on voBits:
	
	    https://voBits.github.io/#!/trade/BLAH-ETH
	...
	def twitter_short_style(token_info):
	    """
	    Blah Token $BLAH by [@blah_com|blah.com] https://voBits.github.io/#!/trade/BLAH-ETH
	    """
	    ...
	    return "{token_name} ${symbol} by {issuer_attr} https://voBits.github.io/#!/trade/{symbol}-ETH #{symbol}".format(
	        token_name=token_name, symbol=symbol, issuer_attr=issuer_attr,
	    )
	...
	def github_response_style(token_info):
	    """
	    Thank you for your request! $BLAH token has been listed: https://voBits.github.io/#!/trade/BLAH-ETH. We will announce it on our channels shortly.
	
	    If you like our project, please consider [donating](https://voBits.github.io/about/#donate). Your donations keep the project running and are always appreciated.
	    """
	
	    symbol = token_info["symbol"] if not "__FORKDELTA_CUSTOM_SYMBOL" in token_info else token_info["__FORKDELTA_CUSTOM_SYMBOL"]
	
	    return "Thank you for your request! {name} has been listed: https://voBits.github.io/#!/trade/{symbol}-ETH".format(name=token_info["name"], symbol=symbol) \
	        + "\n\nIf you like our project, please consider [donating](https://voBits.github.io/about/#donate). Your donations keep the project running and are always appreciated."
